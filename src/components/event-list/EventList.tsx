...
export const EventItem = ({ event }: { event: Event }) => {
  ...
  return (
    <div>
      {/* Above's wrapper div added intentionally to avoid grid item height issue */}
      <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white w-full shadow-md shadow-slate-100">
        <div>
